            ...
            <div className="row g-0">
              ...
              <div className="px-4 ">
                ...
                {messages.map((message) =>
                  <Link 
                    key={`${message?.id}-${message?.sender}-${message?.receiver}`}
                  ...
                  >
                    <small>
                        ...
                        {message.sender === user_id ? 'Sent ' : 'Received '}
                    ...
                    {message.sender === user_id && 
                      ...
                      <div className="flex-grow-1 ml-3">
                          ...
                          {message.sender !== user_id && 
                            (message.sender_profile.full_name !== null ? message.sender_profile.full_name : message.sender.username) 
                          }
                        <div className="small">
